...
const WaRevenueTaxes = () => {
    ...
    return (
        <div className="App">
            ...
            <RevenueGraph title="Taxes" link="https://gw.alipayobjects.com/os/bmw-prod/1d565782-dde4-4bb6-8946-ea6a38ccf184.json" />
